function [LFP, EMG, outputPath, pre_pro_params] = pre_processing(app,CA1_data_import,EMG_data_import,pre_processing_state)
...
if pre_processing_state  % If it is true, the pre-processing step is going to be executed
    ...
    EMG_data_import.data(n*m+1:end) = [];
