classdef RMS_pwelch_integrate < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        EMGChannelDropDownLabel         matlab.ui.control.Label
        EMGChannelDropDown              matlab.ui.control.DropDown
        ...
        Load2Button                     matlab.ui.control.Button
    end
    ...
    methods (Access = private)
        ...
        function UpdateWorkspace(app)
            ...
            app.EMGChannelDropDown.Items = variableNames; % EMG drop down list
...
%                     savetmp(temp_file_name,true,'preprocessing_temporary_period_separation');
    ...
    methods (Access = private)
        ...
        % Button pushed function: Load2Button
...
%                         app.Selected_radio_button_tag = app.FiltertypeButtonGroup.Buttons(1).Tag;
        ...
        function CA1ChannelDropDownValueChanged(app, event)
            ...
            % EMG drop down
            if app.CA1ChannelDropDown.Value == app.EMGChannelDropDown.Value
                % Clears the EMG drop down
                app.EMGChannelDropDown.Value = [];
            end
        end

        % Value changed function: EMGChannelDropDown
        function EMGChannelDropDownValueChanged(app, event)
            % Make sure that the selected value will be different from the
            % EMG drop down
            if app.EMGChannelDropDown.Value == app.CA1ChannelDropDown.Value
                % Clears the EMG drop down
...
%             end
        ...
        function RunButton_classification_algorithmPushed(app, event)
            ...
            switch app.Algorithm_selected_radio_button_tag % Get which radio button was selected
                case 'workspace'
                    ...
                    % EMG
                    selected_var_name_EMG = app.EMGChannelDropDown.Value;  % Get the selected EMG var name from the drop box
                    ...
                    GMM_Classifier_Training_fixed(app,app.Workspace(selected_index_CA1),app.Workspace(selected_index_EMG),pre_process_state,load_data,selected_indices)
        ...
        function SleepWakeAlgorithmButtonGroupSelectionChanged(app, event)
            ...
            switch app.Algorithm_selected_radio_button_tag                
                case 'workspace' % Default (it will use the variables already in the workspace)
                    ...
                    app.EMGChannelDropDown.Enable = true;
                    app.CA1ChannelDropDown.Enable = true;
                    app.EMGChannelDropDownLabel.Enable = true;
                ...
                case 'load_file' % It will load a set of variables previously saved after the algorithm pre-processing step
                    ...
                    app.EMGChannelDropDown.Enable = false;
                    app.CA1ChannelDropDown.Enable = false;
                    app.EMGChannelDropDownLabel.Enable = false;
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.SleepwakecycleclassificationsoftwareUIFigure.Position = [100 100 856 538];
            ...
            app.GridLayout2.RowHeight = {120, 300, '1x'};
            ...
            app.TabGroup.Position = [1 55 439 166];
            ...
            app.SleepWakeAlgorithmButtonGroup.Position = [7 7 426 235];
            ...
            app.UseworkpacedataButton.Position = [21 176 142 22];
            ...
            app.LoadpreprocessedvariablesButton_2.Position = [266 166 146 42];
            ...
            app.CA1ChannelDropDownLabel.Position = [19 149 77 22];
            ...
            app.CA1ChannelDropDown.Position = [111 149 100 22];
            app.CA1ChannelDropDown.Value = {};

            % Create EMGChannelDropDownLabel
            app.EMGChannelDropDownLabel = uilabel(app.SleepWakeAlgorithmButtonGroup);
            app.EMGChannelDropDownLabel.HorizontalAlignment = 'right';
            app.EMGChannelDropDownLabel.Position = [19 119 81 22];
            app.EMGChannelDropDownLabel.Text = 'EMG Channel';

            % Create EMGChannelDropDown
            app.EMGChannelDropDown = uidropdown(app.SleepWakeAlgorithmButtonGroup);
            app.EMGChannelDropDown.Items = {};
            app.EMGChannelDropDown.ValueChangedFcn = createCallbackFcn(app, @EMGChannelDropDownValueChanged, true);
            app.EMGChannelDropDown.Position = [112 119 100 22];
            app.EMGChannelDropDown.Value = {};
            ...
            app.IncludethealgorithmpreprocessingstepCheckBox.Position = [21 83 147 28];
            ...
            app.RunButton_classification_algorithm.Position = [362 14 50 34];
            ...
            app.PowerLineNoiseHzLabel.Position = [13 14 69 28];
            ...
            app.PowerLineNoiseHzEditField.Position = [82 17 54 22];
            ...
            app.OutputSamplingFrequencyLabel.Position = [149 14 95 28];
            ...
            app.OutputSamplingFrequencyDropDown.Position = [259 20 87 22];
            ...
            app.Selectthedata_variablematfileLabel.Position = [259 109 162 42];
            ...
            app.ststepSelectiononeoftheoptionsbellow1or2Label.Position = [73 207 307 22];
            ...
            app.ndstepChangetheparametersbellowandpressRunLabel.Position = [60 49 334 22];
            ...
            % Create Load2Button
            app.Load2Button = uibutton(app.SleepwakecycleclassificationsoftwareUIFigure, 'push');
            app.Load2Button.ButtonPushedFcn = createCallbackFcn(app, @Load2ButtonPushed, true);
            app.Load2Button.Position = [29 582 100 22];
            app.Load2Button.Text = 'Load2';
