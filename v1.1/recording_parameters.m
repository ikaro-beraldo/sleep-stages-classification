classdef recording_parameters < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        ItmighttakeabitlongbecausetheepochsaregoingtobeloadedLabel  matlab.ui.control.Label
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.SavesomerepresentativeepochsCheckBox.Position = [385 143 204 22];
            ...
            app.RunvisualinspectionPanel.Position = [365 189 325 115];
            ...
            app.RunvisualinspectionMandatoryforthefirsttimeCheckBox.Position = [20 65 293 23];
            app.RunvisualinspectionMandatoryforthefirsttimeCheckBox.Value = true;

            % Create ItmighttakeabitlongbecausetheepochsaregoingtobeloadedLabel
            app.ItmighttakeabitlongbecausetheepochsaregoingtobeloadedLabel = uilabel(app.RunvisualinspectionPanel);
            app.ItmighttakeabitlongbecausetheepochsaregoingtobeloadedLabel.Position = [44 37 250 29];
            app.ItmighttakeabitlongbecausetheepochsaregoingtobeloadedLabel.Text = {'It might take a bit long because the epochs'; 'are going to be loaded'};
            ...
            app.ContinueanunfinishedvisualinspectionCheckBox.Position = [44 9 237 22];
            ...
            app.StartfromthelaststepcompletedCheckBox.Position = [385 109 202 22];
